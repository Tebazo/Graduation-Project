\chapter{Anexo A - Código Fonte}
\section{startUp.java}
Essa classe é responsável por iniciar toda a plataforma de agentes. \\
...
Essa classe auxilia na manipulação de estruturas que representam o grafo de relações entre os agentes. \\
\lstinputlisting{codigo/ProcessaRelacoes.java}
\section{OutputUtils.java}
Essa classe padroniza todo o output dos agentes para a saída padrão. \\
...
Essa classe armazena todas as possíveis habilidades dos agentes.  \\
